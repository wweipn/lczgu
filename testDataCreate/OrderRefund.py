...
if __name__ == '__main__':
    ...
    "申请退款"
    # apply_refund(token=common.user_token(18123929299), order_goods=1385508033362169857)

    "申请售后: 1: 退款, 2: 退货退款, 3: 换货"
    apply_post_sale(token=common.user_token(18123929299), order_goods=1385525047673872386, post_sale_type=3)
